...
export default class Add extends Component {
    constructor(props) {
      ...
      componentDidMount() {
            axios({
                method: 'get',
                url: CONFIG.APP_ENDPOINT + "get_employee/"+this.props.match.params.id,
            }).then((res)=>{
                console.log(res);
                if(res.data.key===1){ 
                    this.setState({                         
                        ...
                        position:  res.data.txt.position,
                        salary: res.data.txt.salary,
                        contract:  res.data.txt.contract,
                        probation:  res.data.txt.probation,
                     });
                }
  ...
  onSubmit = (e) => {
    ...
    axios({
    method: 'post',
    url: CONFIG.APP_ENDPOINT + "update_employee/" + this.props.match.params.id,
    data: params
    }).then((res)=>{
        console.log(res);
        if(res.data.key===1){
